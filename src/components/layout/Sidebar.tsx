...
export const Sidebar: React.FC<SidebarProps> = ({ collapsed, onToggleCollapse }) => {
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      defaultGroup: 'CLINIC',
      items: [
        { nameKey: 'patients', defaultName: 'Patients', href: '/patients', icon: Users },
        { nameKey: 'doctors', defaultName: 'Doctors', href: '/doctors', icon: UserCheck },
        { nameKey: 'appointments', defaultName: 'Appointments', href: '/appointments', icon: Calendar },
        { nameKey: 'medicalRecords', defaultName: 'Medical Records', href: '/medical-records', icon: FileText },
        { nameKey: 'prescriptions', defaultName: 'Prescriptions', href: '/prescriptions', icon: Pill },
      ],
    },
    {
      groupKey: 'INVENTORY',
      ...
      items: [
        { nameKey: 'products', defaultName: 'Products & Drugs', href: '/products', icon: Activity },
      ],
    },
    {
      groupKey: 'FINANCE',
      ...
      items: [
        { nameKey: 'payments', defaultName: 'Payments', href: '/payments', icon: CreditCard },
      ],
    },
    {
      groupKey: 'AI SUITE',
    ...
    },
    {
      ...
      defaultGroup: 'ADMIN',
      items: [
        { nameKey: 'users', defaultName: 'Users & Roles', href: '/users', icon: ShieldCheck },
        { nameKey: 'settings', defaultName: 'System Settings', href: '/settings', icon: Settings },
      ],
    },
  ];
              ...
              <div className="space-y-1">
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className={`w-4 h-4 shrink-0 ${isActive ? 'text-white' : item.isAi ? 'text-purple-600' : 'text-slate-500'}`} />
